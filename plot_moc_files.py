...
file_HETDEX = 'CDS-J-A+A-622-A1-merge_MOC_level_8.fits'
file_S82    = 'CDS-J-AJ-142-3-stripe82_MOC_level_8.fits'
...
moc = MOC.from_fits(gv.moc_path + file_name)
...
with WCS(fig, 
    ...
    moc.fill(ax=ax, wcs=wcs, alpha=1.0, fill=True, color=plt.get_cmap('cet_gouldian')(0.5), linewidth=1.0)
    moc.border(ax=ax, wcs=wcs, alpha=1.0, color='k', lw=1.5)
